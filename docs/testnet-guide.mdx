...
<img src="./img/OpenSea Profile.png" alt="OpenSea Profile" />
3\. When you mint an NFV you'll be able to see it in your account page as seen in the image below.

<img src="./img/OpenSea NFV.png" alt="OpenSea NFV" />

4\. You can also view existing NFVs from other users on the [Open Dollar Vaults](https://opensea.io/collection/open-dollar-vaults) collection page.
