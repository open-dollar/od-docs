...
4. Add the "Arbitrum Sepolia" testnet to your wallet & switch networks. [https://chainlist.org/?search=arbitrum+sepolia\&testnets=true](https://chainlist.org)
