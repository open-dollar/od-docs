...
The measure of how quickly or easily you can convert a given asset to another asset without slippage.
...
Slippage is a discrepancy between the expected price of a cryptocurrency and the price at which the order is filled, most often due to low liquidity.
