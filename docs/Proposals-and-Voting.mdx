...
Discussions related to Open Dollar DAO governance can be found on: [https://forum.opendollar.com/](https://forum.opendollar.com/)
...
Proposal Delay: 12 hours

From the time the proposal is live there is a 12 hour delay before voting occurs. This is to give voters and delegates adequate time to prepare.
...
After the first proposal is passed, there is no delay before it can be executed so we can increase the debt ceiling to launch Open Dollar immediately and have the flexibility to make necessary changes quickly.

One of the first proposals we expect to make after launch is an increase in the timelock delay to 1 day, to increase security.

Proposal Threshold: 5,000

5,000 ODG is the minimum required voting power to create a proposal. This is designed to be high enough to filter spam yet low enough to be accessible either independently or by delegation.

Quorum: 20,000

20,000 is the minimum number of votes required for a proposal to be valid. ”No” votes do not count towards quorum.
