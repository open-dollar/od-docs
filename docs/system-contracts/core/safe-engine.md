...
* `coinBalance[user: address]` - how many coins an account has. This number is **not** reflected in the [external ERC20 token contract](https://docs.opendollar.com/system-contracts/token-module/system-coin).
