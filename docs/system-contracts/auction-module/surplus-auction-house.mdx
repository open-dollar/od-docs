...
In the context of running a keeper (more info [here](https://github.com/reflexer-labs/geb-docs/tree/master/keepers)) in order to perform bids within an auction, a primary failure mode could occur when a keeper specifies an unprofitable price for ODG.
