...
This contract inherits functionality from the [IncreasingTreasuryReimbursement](/system-contracts/sustainability-module/increasing-treasury-reimbursement) contract.
