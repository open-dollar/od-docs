...
New ODG tokens can NOT be minted by the DAO, the team, or anyone else. New ODG can only be minted by the protocol autonomously in cases of emergency, when there is bad debt that needs to be settled. \
\
Check out the developer docs on the [Debt Auction House](https://docs.opendollar.com/system-contracts/auction-module/debt-auction-house) for more info.

Read more on our [blog](https://www.opendollar.com/blog/the-odg-token-launch).
