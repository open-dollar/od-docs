...
Initially, vaults for wstETH and rETH will be available with overcollateralization ratio requirementes of 135%. This ensures that the minted OD is sufficiently backed by collateral, maintaining the protocol's stability and security.
