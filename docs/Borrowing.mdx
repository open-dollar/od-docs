...
<img src="./img/Creating a Vault.png" alt="Creating a Vault" />
...
Borrowing fees vary by collateral type with a maximum fee of 2% APR for LSTs. See [Supported Collaterals](https://docs.opendollar.com/Supported-Collaterals) to learn more.
