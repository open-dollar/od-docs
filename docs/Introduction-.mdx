...
Open Dollar’s protocol is non-ungradable and the DAO cannot upgrade the code in any malicious way because the protocol is ungoverned, safeguarding against the risks associated with leaving protocol governance solely in the hands of token holders.
